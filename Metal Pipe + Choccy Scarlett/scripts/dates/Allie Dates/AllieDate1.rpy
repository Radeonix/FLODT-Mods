...
"How I let Allie talk me into this, I'll never know."
m "You sure this is a good idea?"
show a laugh at pos50a with dissolve
a "There's only one way to find out, isn't there?"
"Allie grabbed my hand and pulled me towards the slope of the hill."
show a happy
a "Relax, [name]. What's the worst that could happen?"
m "Well, I could die."
"Would it be too much to ask to be on a TV Show that didn't end up with me dead?"
show a laugh
...
#with vpunch # Allie
a "Oh shi-"
"Allie slipped on her roller blades, pulling me down the hill with her."
"I tried to step back up on reflex, but it was all I could do to stand up with the roller blades."
m "Oh fu-"
with vpunch
...
menu:
    "With the power of misplaced confidence and adrenaline, I jumped high into the air..."
